...
const WanderLust = () => {
  return (
    <div className='container p-5 text-center mt-5'>
      ...
      <img src='media\wanderlust.png' alt='WanderLust' style={{maxWidth:"100%", width:"50rem",borderRadius:"1rem" ,marginTop:"2rem"}}/>
      ...
      <p style={{fontFamily:"Georgia",fontSize:"1.2rem"}}>Live Link :- </p> <a target="_blank" rel="noreferrer" href=' https://wanderlust-t9iy.onrender.com'> https://wanderlust-t9iy.onrender.com</a>
    </div>
  )
}
